...
// import '../Assets/css/pulsa.css'

export function Pulsa() {
    const [inputValue, setInputValue] = useState("");
    const [showProductsPulsaTelkomsel, setShowProductsPulsaTelkomsel] = useState(false);
    ...
    const handleInputChange = (event) => {
        ...
        if (value.includes("0853") || value.includes("0823")) {
            setShowProductsPulsaTelkomsel(true);
            setSelectedOperator("telkomsel");
        } else if (value.includes("089")) {
            setShowProductsPulsaTelkomsel(true);
            setSelectedOperator("xl");
        } else {
            setShowProductsPulsaTelkomsel(false);
            setSelectedOperator("");
        }
    };
    const isInputInvalid = inputValue.length > 13;

    const toPulsaTelkomsel = () => {
        window.location.href = '/pulsa/telkomsel';
    };
    ...
    const toCheckout = (item) => {
        ...
        // localStorage.setItem('selectedProduct', [selectedProductJSON, inputValue]);
        localStorage.setItem('dataTransaction_DONT_CHANGE', JSON.stringify(dataToStore));
        // localStorage.setItem('phoneNumber', inputValue);
        // window.location.href = '/checkoutpulsa';
        navigate('/checkoutpulsa');
    };
    ...
    const getProductxl = () => {
        // fetch("http://localhost/phpdasar/phpcrud/api/products/pulsa_xl.php")
        fetch("https://testreactlaravel.000webhostapp.com/backend/products/pulsa_xl.php")
            .then(res => { return res.json() })
            ...
            <div className="bodyPulsa">
                <div className="headerPulsa">
                    <nav class="navbar-light text-center" style={{ padding: '13px', boxShadow: '0px 0px 6px rgba(0, 0, 0, 0.30)', zIndex: '15', background: 'white', position: 'fixed', width: '100%', maxWidth: '450px' }}>
                        <a class="navbar-brand" style={{ fontSize: '15px' }}><b>Isi Pulsa</b></a>
                    ...
                    <div className="container" style={{ paddingTop: '50px' }}>
                        <div className="mt-3" style={{ padding: '15px', borderRadius: '6px', backgroundColor: 'white' }}>
                            <div className="text-start">
                                ...
                                {isInputInvalid ? (
                                    ...
                                    <div>
                                        {/* TELKOMSEL */}
                                        {showProductsPulsaTelkomsel && selectedOperator === 'telkomsel' && (
                                            <div className="mt-4">
                                                            ...
                                                            <div class="col-6 mt-2">
                                                                <div class="card">
                                                                    <div class="card-body" style={{ textAlign: 'left' }}>
                                                                        ...
                                                                        <small class="card-text" style={{ fontSize: '12px', color: 'gray' }}>Harga</small>
                                                                        <p class="card-text" style={{ fontSize: '17px', color: 'rgb(255, 96, 96)', fontFamily: 'inherit' }}><b>{formatRupiah(item.amount)}</b></p>
                                                                        <button onClick={() => toCheckout(item)} style={{ width: '100%' }} class="btn btn-success">Beli</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ))}
                                        ...
                                        {/* XL */}
                                        {showProductsPulsaTelkomsel && selectedOperator === 'xl' && (
                                            <div className="mt-4">
                                                <div className="wrapping">
                                                    <div className="text-start d-flex justify-content-between">
                                                        <small><b>Pilih Nominal:</b></small>
                        ...
                        <div>
                            <div className="text-start mt-3">
                                <small><b>Beli Pulsa Lainnya</b></small>
                            </div>
                            <div className="otherPulsa mt-2">
                                <div class="row d-flex justify-content-center align-items-center" data-aos="fade-up" data-aos-delay="400">
                                    ...
                                    <div className="card1 col-3 d-flex justify-content-center align-items-center" onClick={() => { getProduct() }}>
                                        <div className="mt-3">
                                            <div>
                                            ...
                                            <div className="text-justify mt-3">
                                                <p style={{ fontSize: '10px' }}>Pulsa Telkomsel</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="card2 col-3 d-flex justify-content-center align-items-center">
                                        <div className="mt-3">
                                            ...
                                            <div className="text-justify mt-3">
                                                <p style={{ fontSize: '11px' }}>Pulsa IM3</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="card3 col-3 d-flex justify-content-center align-items-center">
                                        <div className="mt-3">
                                            ...
                                            <div className="text-justify mt-3">
                                                <p style={{ fontSize: '11px' }}>Pulsa XL</p>
                                            </div>
                                        </div>
                                    </div>
...
export function Checkout() {
    ...
    const handlePay = () => {
        ...
        // formData.append('id_pulsa_telkomsel', selectedProduct.id);
